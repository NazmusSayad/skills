...
Prioritize simplicity and readability over reusability or abstraction. Do not introduce variables, functions, helpers, types, or other abstractions unless the logic becomes very large and extremely complex or repeated many times.
